...
fig_1a
tiff("fig_1a.tiff", units = "in", width=7, height=5, res=400)
print(fig_1a)
dev.off()
```
...
fig_1b
tiff("fig_1b.tiff", units = "in", width=3, height=4, res=300)
print(fig_1b)
dev.off()
```
...
fig_s3
tiff("fig_s3.tiff", units = "in", width=8, height=4, res=600)
print(fig_s3)
dev.off()
```
...
fig_s4<- df %>%
  ...
  theme(legend.position="top",
        ...
        legend.text =element_text(size=6,face="bold", color="black"))
fig_s4
tiff("fig_s4.tiff", units = "in", width=7, height=5, res=400)
print(fig_s4)
dev.off()
```
...
fig_s5
tiff("fig_s5.tiff", units = "in", width=8, height=7, res=800)
print(fig_s5)
dev.off()
```
...
tiff("fig_2.tiff", units = "in", width=6, height=4, res=600)
print(fig_2)
dev.off()
```
...
fig_s7
tiff("fig_s7.tiff", units = "in", width=6, height=4, res=400)
print(fig_s7)
dev.off()
```
...
fig_s9
tiff("fig_s9.tiff", units = "in", width=6, height=4, res=400)
print(fig_s9)
dev.off()
```
...
fig_s11
tiff("fig_s11.tiff", units = "in", width=6, height=4, res=300)
print(fig_s11)
dev.off()
```
...
fig_s12
tiff("fig_s12.tiff", units = "in", width=6, height=4, res=300)
print(fig_s12)
dev.off()
```
...
fig_s8
tiff("fig_s8.tiff", units = "in", width=6, height=4, res=300)
print(fig_s8)
dev.off()
``` 
...
pca_site
tiff("pca_site.tiff", units = "in", width=5, height=5, res=300)
print(pca_site)
dev.off()
```
...
pca_pos
tiff("pca_pos.tiff", units = "in", width=5, height=5, res=300)
print(pca_pos)
dev.off()
```
...
fig_s17
tiff("fig_s17.tiff", units = "in", width=8, height=5, res=400)
print(fig_s17)
dev.off()
```
...
fig_s6
tiff("fig_s6.tiff", units = "in", width=9, height=6, res=600)
print(fig_s6)
dev.off()
```